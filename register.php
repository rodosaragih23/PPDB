...
<html lang="en">
  ...
  <!-- Global site tag (gtag.js) - Google Analytics -->
	...
	<style>body{background-color:#2c3e50;}
...
.btn{
  ...
  <div align="center">
    ...
    <a href="index.php"><img src="logo.png" width="10%" style="margin-top:2%" \></a>

	<br \><br \>
			<div class="container">
					<div style="color:white">
					<h2>Pendaftaran PSB Online</h2><br \>
                ...
                <form method="post">
                    ...
                    <a class="btn btn-info text-light" href="login.php">Login</a>
                </form>
